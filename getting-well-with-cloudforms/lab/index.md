...
- [Build a Service Catalog with CloudForms](#build-a-service-catalog-with-cloudforms)
    - [Introduction to CloudForms](#introduction-to-cloudforms-1)
    - [Setup the lab environment](#setup-the-lab-environment-1)
    - [Access the lab environment](#access-the-lab-environment-1)
    - [Verify provider status](#verify-provider-status)
        - [OpenStack Provider status](#openstack-provider-status-1)
        - [Red Hat Virtualization Provider status](#red-hat-virtualization-provider-status-1)
